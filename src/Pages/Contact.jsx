    ...
    <>
      <div className="text-center lg:mt-[5%] mt-10 mb-2 sm:px-0 px-[5%]">
        <h2
          ...
          className="inline-block text-3xl md:text-5xl font-bold text-center mx-auto text-transparent bg-clip-text bg-gradient-to-r from-[#3b82f6] to-[#06b6d4]"
        >
          <span
            style={{
              color: "#3b82f6",
              backgroundImage:
                "linear-gradient(45deg, #3b82f6 10%, #06b6d4 93%)",
        ...
        >
          Tem alguma pergunta? Me manda uma mensagem que eu respondo em breve.
        </p>
      </div>

      <div
        className="h-auto py-10 flex items-center justify-center px-[5%] md:px-6 lg:px-12"
        id="Contact"
      >
        <div className="container px-4 md:px-6 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-[45%_55%] 2xl:grid-cols-[35%_65%] gap-12">
          <div
            data-aos="fade-right"
            data-aos-duration="1200"
            className="bg-white/5 backdrop-blur-xl rounded-3xl shadow-2xl p-5 py-10 sm:p-10 transform transition-all duration-300 hover:shadow-[#3b82f6]/10"
          >
            <div className="flex justify-between items-start mb-8">
              <div>
                ...
                <p className="text-gray-400">
                  Tem algo pra discutir? Manda sua mensagem e vamos conversar.
                </p>
              </div>
            ...
            <form 
              action="https://formsubmit.co/joaquimc2y99@gmail.com"
              method="POST"
          ...
          <div className="bg-white/5 backdrop-blur-xl rounded-3xl p-3 py-3 md:p-10 md:py-8 shadow-2xl transform transition-all duration-300 hover:shadow-[#3b82f6]/10">
            <Komentar />
          </div>
        </div>
      </div>
