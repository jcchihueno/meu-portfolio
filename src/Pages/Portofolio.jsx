...
const techStacks = [
  ...
  { icon: "adobe-illustrator.svg", language: "Illustrator" },
  { icon: "adobe-photoshop.svg", language: "Photoshop" },
  { icon: "Affinity.svg", language: "Affinity" },
...
export default function FullWidthTabs() {
  ...
  const [categoryFilter, setCategoryFilter] = useState("all"); // "all" | "code" | "design"
  ...
  const fetchData = useCallback(async () => {
    try {
      const projectCollection = collection(db, "projetos");
      const certificateCollection = collection(db, "certificados");
    ...
    <div className="md:px-[10%] px-[5%] w-full sm:mt-0 mt-[3rem] bg-[#030014] overflow-hidden" id="Portofolio">
      ...
      <div className="text-center pb-10" data-aos="fade-up" data-aos-duration="1000">
        ...
        <p className="text-slate-400 max-w-2xl mx-auto text-sm md:text-base mt-2">
          Acompanhe minha jornada através de projetos, certificados e habilidades técnicas. Cada seção representa um marco no meu processo contínuo de aprendizado.
        </p>
      </div>
